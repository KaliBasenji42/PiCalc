...
def strLessThan(str1, str2): # Compares 2 strings, returns True if str1 < str2
  ...
  logging.debug('len(str1Arr[0]): ' + str(len(str1Arr[0])))
  
  for i in range(len(str1Arr[0])): # Loop for integer digits
    if(int(str1Arr[0][i]) < int(str2Arr[0][i])):
      DBStr += str1Arr[0][i] + ' < ' + str2Arr[0][i] + '\n'
      out = True # str1 < str2
      break
    if(int(str1Arr[0][i]) > int(str2Arr[0][i])):
      DBStr += str1Arr[0][i] + ' > ' + str2Arr[0][i] + '\n'
  ...
  for i in range(len(str1Arr[1])): # Loop for fractional digits
    if(int(str1Arr[1][i]) < int(str2Arr[1][i])):
      DBStr += str1Arr[1][i] + ' < ' + str2Arr[1][i] + '\n'
      out = True # str1 < str2
      break
    if(int(str1Arr[1][i]) > int(str2Arr[1][i])):
      DBStr += str1Arr[1][i] + ' > ' + str2Arr[1][i] + '\n'
