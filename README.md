...
Infinite sum that converges onto the Riemann Zeta function given the arguments \[$x$\], ζ(x).  
...
Infinite sum that converges onto the Dirichlet Beta function given the arguments \[$x$\], $β(x)$.  
